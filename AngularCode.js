...
app.controller("myCtrl", function ($scope, $http) {
    ...
    $scope.InsertData = function () {
        ...
        if (Action == "Submit") {
            ...
            $http({
                method: "post",
                url: "http://localhost:26101/Employee/Insert_Employee",
                datatype: "json",
        ...
        else
        {
            ...
            $http({
                method: "post",
                url: "http://localhost:26101/Employee/Update_Employee",
                datatype: "json",
                data: JSON.stringify($scope.Employe)
            }).then(function (response) {
                alert(response.data);
    ...
    $scope.GetAllData = function ()
    {
        $http({
            method: "get",
            url: "http://localhost:26101/Employee/Get_AllEmployee"
        }).then(function (response)
        {
    ...
    $scope.DeleteEmp = function (Emp) {
        $http({
            method: "post",
            url: "http://localhost:26101/Employee/Delete_Employee",
            datatype: "json",
